...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-indy_header_button select' ),
			headerLinkButton: $( '#customize-control-indy_header_button_url' ),
			headerLinkText: $( '#customize-control-indy_header_button_text' )
		};
	};
